...
EXITS=(50 0 100 0 100 0 0 50 100 50)
EMPTY="#"
QUIET=0
KEEP=0
SIG=""
...
OUTP01=$(cat <<EOL
Unesite niz brojeva:     -4   -12   -5   -456
Greska! Uneta cifra nije pozitivan broj u decimalnom sistemu!
...
OUTP02=$(cat <<EOL
Unesite niz brojeva:12 56 9 256 
Zbir kvadrata niza je (Bez najmanjeg broja):68816
...
OUTP03=$(cat <<EOL
Unesite niz brojeva:235236663737 23 1 8
Greska! Doslo je do prekoracenja!
...
OUTP04=$(cat <<EOL
Unesite niz brojeva:1 2 3 4 5
Zbir kvadrata niza je (Bez najmanjeg broja):54
...
OUTP05=$(cat <<EOL
Unesite niz brojeva:123456 124 6 12 6 8
Greska! Doslo je do prekoracenja!
...
OUTP06=$(cat <<EOL
Unesite niz brojeva:           3          
Zbir kvadrata niza je (Bez najmanjeg broja):0
...
OUTP07=$(cat <<EOL
Unesite niz brojeva: 666     8     2
Zbir kvadrata niza je (Bez najmanjeg broja):443620
...
OUTP08=$(cat <<EOL
Unesite niz brojeva:525 6!41 7 323
Greska! Uneta cifra nije pozitivan broj u decimalnom sistemu!
...
TEST09=$(cat <<EOL
251126912616 116126 7237                                    
EOL
)

OUTP09=$(cat <<EOL
Unesite niz brojeva:251126912616 116126 7237 
Greska! Doslo je do prekoracenja!
...
if [ "$1" != "" ] && [ -f "$1" ]; then
    ...
    gcc -g -m32 -o zad zad.S 1>$OUT1 2>&1
